...
open licence, and an anonymised mirror of the repository is available for
review at \url{https://anonymous.4open.science/r/bluffhouse-3435/}. It
carries the run artifacts as a single archive at the repository root: the
event logs, per-agent observation streams and provider transcripts described
below, from which \texttt{paper/analysis.py} reproduces every table without
re-querying any provider. The unanonymised repository is linked in the
