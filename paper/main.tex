...
tiers we tested. Trajectory-level social evaluation is expensive in a way
single-turn benchmarks are not, and the cost falls on repeated trials---the
axis where an evaluation can least afford to economize.
...
\textbf{What differencing cannot do.} Modes 0 and 6 present
...
payoff. The declination is not a capability ceiling, not a parsing
